                    ...
                    <div className="row clearfix">
                        <div className="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div className="footer-widget logo-widget">
                                ...
                                <div className="text">
                                    <p>At go shop, our purpose is to enrich lives through the latest products. We do that by leveraging our unique combination of tech expertise and human touch to meet our customers’ everyday needs.</p>
                                </div>
                            ...
                            <div className="footer-widget contact-widget">
                                ...
                                <div className="widget-content">
                                    <ul className="info-list clearfix">
                                        <li><i className="fa fa-map-marker-alt"></i>Flat 20, Reynolds Neck, North Helenaville, FV77 8WS</li>
                                        <li><i className="fa fa-microphone"></i><a href="tel:23055873407">+1(305) 587-3407</a></li>
                                        <li><i className="fa fa-envelope"></i><a href="mailto:info@example.com">info@goshop.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
